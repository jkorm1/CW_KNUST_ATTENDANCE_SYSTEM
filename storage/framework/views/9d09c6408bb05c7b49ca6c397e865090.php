...
<div class="container mx-auto py-6 max-w-4xl">
    ...
    <form action="<?php echo e(route('first_timers.store')); ?>" method="POST" class="space-y-6 font-montserrat bg-white shadow-md rounded-lg p-6 border border-[#3a1d09]" id="bulkFirstTimersForm">
        <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select name="first_timers[0][service_id]" class="w-full px-3 py-2 border border-[#3a1d09] rounded-md service-select" required>
                        ...
                        <?php $__currentLoopData = $allServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <option value="<?php echo e($serviceId); ?>" data-date="<?php echo e($dateValue); ?>">
                                <?php echo e($service['name'] ?? $service->name); ?> - <?php echo e(\Carbon\Carbon::parse($serviceDate)->format('D, d M Y')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('Register First Timers')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/first_timers/create.blade.php ENDPATH**/ ?>